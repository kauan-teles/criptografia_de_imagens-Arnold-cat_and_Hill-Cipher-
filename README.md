...
,p>Por se tratar de um sistema simétrico, a encriptação e a descriptação dependem da mesma chave, exigindo, no processo inverso, a utilização da matriz inversa correspondente.
